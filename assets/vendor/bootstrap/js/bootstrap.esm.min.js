...
function addHandler(e, t, n, i, s) {
  ...
  const [o, a, r] = normalizeParams(t, n, i),
    l = getEvent(e),
    c = l[r] || (l[r] = {}),
    E = findHandler(c, a, o ? n : null);
  if (E) return void (E.oneOff = E.oneOff && s);
  const _ = getUidEvent(a, t.replace(namespaceRegex, "")),
...
const EventHandler = {
    ...
    off(e, t, n, i) {
      if ("string" != typeof t || !e) return;
      const [s, o, a] = normalizeParams(t, n, i),
        r = a !== t,
        l = getEvent(e),
        c = t.startsWith(".");
      if (void 0 !== o) {
      ...
      Object.keys(E).forEach((n) => {
        ...
        if (!r || t.includes(i)) {
          const t = E[n];
          removeHandler(e, l, a, t.originalHandler, t.delegationSelector);
        }
      });
    },
    trigger(e, t, n) {
      ...
      return (
        ...
        E && _.preventDefault(),
        c && e.dispatchEvent(_),
        _.defaultPrevented && void 0 !== r && r.preventDefault(),
        _
      );
    },
  },
...
class BaseComponent {
  ...
  _queueCallback(e, t, n = !0) {
    ...
    const i = getTransitionDurationFromElement(t);
    EventHandler.one(t, "transitionend", () => execute(e)),
...
class Carousel extends BaseComponent {
  ...
  _getConfig(e) {
    return (
      (e = { ...Default$9, ...e }), typeCheckConfig(NAME$a, e, DefaultType$9), e
    );
  }
  _handleSwipe() {
  ...
  _getItemByOrder(e, t) {
    ...
    const a = (s + (i ? -1 : 1)) % this._items.length;
  ...
  static carouselInterface(e, t) {
    let n = Data.get(e, DATA_KEY$9),
      i = { ...Default$9, ...Manipulator.getDataAttributes(e) };
...
class Dropdown extends BaseComponent {
  ...
  _selectMenuItem(e) {
    const t = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, this._menu).filter(
      isVisible
    );
    if (!t.length) return;
    let n = t.indexOf(e.target);
    "ArrowUp" === e.key && n > 0 && n--,
      "ArrowDown" === e.key && n < t.length - 1 && n++,
      (n = -1 === n ? 0 : n),
      t[n].focus();
  }
  ...
  static dataApiKeydownHandler(e) {
    ...
    t || ("ArrowUp" !== e.key && "ArrowDown" !== e.key)
      ? t && "Space" !== e.key
        ? Dropdown.getInstance(n())._selectMenuItem(e)
        : Dropdown.clearMenus()
      : n().click();
  }
}
...
const SELECTOR_FIXED_CONTENT =
  ...
  _disableOverFlow = () => {
    ...
    e && Manipulator.setDataAttribute(document.body, "overflow", e),
...
class Backdrop {
  ...
  _emulateAnimation(e) {
    ...
    const t = getTransitionDurationFromElement(this._getElement());
    EventHandler.one(this._getElement(), "transitionend", () => execute(e)),
  ...
  static jQueryInterface(e, t) {
    return this.each(function () {
      const n =
        ...
        new Modal(this, "object" == typeof e ? e : {});
      if ("string" == typeof e) {
...
class Offcanvas extends BaseComponent {
  ...
  show(e) {
    this._isShown ||
      ...
      this._backdrop.show(),
      this._config.scroll ||
        (hide(), this._enforceFocusOnElement(this._element)),
      this._element.removeAttribute("aria-hidden"),
      this._element.setAttribute("aria-modal", !0),
      this._element.setAttribute("role", "dialog"),
      this._element.classList.add("show"),
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      const t =
        ...
        new ScrollSpy(this, "object" == typeof e ? e : {});
      if ("string" == typeof e) {
        if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
        t[e]();
      }
...
EventHandler.on(
  ...
  function (e) {
    ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
      isDisabled(this) || (Data.get(this, "bs.tab") || new Tab(this)).show();
  }
),
